...
keps = [300,0,15,0,0,0;      %[km,deg,deg,deg,deg,deg]
        300,0,15,0,120,0;
        300,0,15,0,240,0];
...
figure(1)
[UHF] = pass_over(1,frq_1,powt,powr,keps,lint,t,dt,UHF_G_ele,UHF_G_ele,'MRO/Curiosity LGA UHF',T_s,BW,code);
...
figure(2)
[LGA] = pass_over(0,frq_2,powt,powr,keps,lint,t,dt,LGA_G_ele,LGA_G_ele,'MRO LGA X-Band',T_s,BW,code);