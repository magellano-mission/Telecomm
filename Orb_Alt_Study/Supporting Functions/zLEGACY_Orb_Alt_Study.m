...
[PAX] = MES_PAX_8490(0);
[UHF_G] = MRO_UHF_401_6(0);   %[dBi] MRO / Curiosity UHF antenna curve
...
dt = 5;                  %[s] time step
t = 0: dt : 5*88620;      %[s] Mars day = 88620, Earth day = 86400
...
keps1 = [3788.15,0,92.89,0,pi/4,0];     %[altitude km,deg,deg,deg,deg,deg]
                             %[a,e,i,OM,om,th,mu]
...
hard = sys_hard('UHF2I','UHFB','elec',290,[0 0]);
hard.cont.M =2;
