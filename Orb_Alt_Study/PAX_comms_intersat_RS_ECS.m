...
orb_alts1 = (6400-astroConstants(24)):200:17000;              %[km] altitude range of interest
...
orb_alts2 = 6400-astroConstants(24);              %[km] altitude range of interest
...
hard = sys_hard('PAX','PAX',0,0,'sdst',290,[0 0]);
